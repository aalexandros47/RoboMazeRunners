...
When the parser encounters an UnexpectedToken exception, it creates an interactive parser with the current parse state, allowing you to control how to proceed step-by-step. Once you achieve the correct parse state, you can resume the run by returning True.
