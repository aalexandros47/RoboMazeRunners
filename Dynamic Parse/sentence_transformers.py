'''
Converts text-based logical expressions into structured logical data that can be processed by the logic classes.
Two different parsing approaches are demonstrated. One is based on a custom recursive parsing method, and the other uses the Lark library for more complex grammatical structures.
'''
