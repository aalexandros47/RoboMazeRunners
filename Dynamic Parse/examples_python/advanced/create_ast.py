...
The create_transformer() function collects every subclass of Ast from the module and creates a Lark transformer that builds the AST without requiring any additional code.

This example works only with Python 3.
