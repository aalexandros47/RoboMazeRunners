...
This example demonstrates the use of tree templates to translate between two abstract syntax trees (ASTs). It parses Python 3 code, converts it to a Python 2 AST, and then outputs the result as Python 2 code.
